...
def plot_map_with_number_all_four(data_all, x_ticks, y_ticks):
...
if __name__ == "__main__":
    # 'walking_knee_moment', 'Camargo_100', 'sun_drop_jump', 'opencap_dj', 'opencap_squat', 'opencap_sts'
    da_names = [element + '_output' for element in ['walking_knee_moment', 'Camargo_100', 'sun_drop_jump']]
    test_folder = '2023_05_03_18_22_07_comprehensive_test'
    ...
    with PdfPages(data_path + f'f9_{test_folder}.pdf') as pdf:
        ...
        page.text(0.5, 0.2, title_page_text, transform=page.transFigure, size=8, ha="center")
        plt.tight_layout()
        pdf.savefig()
